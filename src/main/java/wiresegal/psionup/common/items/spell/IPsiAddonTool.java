...
/** Pretty much a copy of IPsimetalTool that doesn't implement IPsiItem, since that brings in some weird ARL VariantHolder stuff, and doesn't seem like it was intended to be used for other things anyways. */
